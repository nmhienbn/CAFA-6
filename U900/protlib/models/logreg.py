...
class LogRegMultilabel:
    ...
    def fit(self, X, y):
        ...
        with cp.cuda.using_allocator(allocator=mempool.malloc):
            ...
            pbar = tqdm.tqdm(list(range(0, y.shape[1], self.output_batch)), desc="Training")
            ...
            for i in pbar:
                ...
                for _ in range(self.max_iter):
                    ...
                    pbar.set_postfix({'delta': float(delta_norm)})
                    ...
                    pbar.write(f'No convergence, delta norm = {delta_norm}')
